...
if($dbu->f('is_trial')==0 && $dbu->f('price_plan_id')!=0)
...
else
	{
		...
		$ft->define(array('main' => "profile_edit_password.html"));
/*
		$ft->assign(array(
			'EMAIL'=>$dbu->gf('email'),
		));
...
$site_meta_title=$meta_title." - Change Password";
$site_meta_keywords=$meta_keywords.", Change Password";
$site_meta_description=$meta_description." Change Password";
