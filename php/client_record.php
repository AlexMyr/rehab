...
$programs = $dbu->query("select exercise_plan.* from exercise_plan where 1=1 exercise_plan.trainer_id=".$_SESSION[U_ID]." AND exercise_plan.client_id=".$glob['client_id']." ");
