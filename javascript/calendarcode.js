...
var img_close;
img_del=new Image();
img_del.src="../javascript/spiffycal/images/btn_del_small.gif";
img_close=new Image();
img_close.src="../javascript/spiffycal/images/btn_close_small.gif";
...
img_Date_UP.src="../javascript/spiffycal/images/btn_date2_up.gif";

img_Date_OVER=new Image();
img_Date_OVER.src="../javascript/spiffycal/images/btn_date2_over.gif";

img_Date_DOWN=new Image();
img_Date_DOWN.src="../javascript/spiffycal/images/btn_date2_down.gif";
...
function Calendar(whatMonth,whatYear) {
    ...
    output += '<td class="cal-HeadCell" align="center" width="100%"><a href="javascript:clearDay();"><img name="calbtn1" src="../javascript/spiffycal/images/btn_del_small.gif" border="0" width="12" height="10"></a>&nbsp;&nbsp;<a href="javascript:scrollMonth(-1);" class="cal-DayLink">&lt;</a>&nbsp;<SELECT class="cal-TextBox" NAME="cboMonth" onChange="changeMonth();">';
    ...
    output += '<\/SELECT>&nbsp;<a href="javascript:scrollMonth(1);" class="cal-DayLink">&gt;</a>&nbsp;&nbsp;<a href="javascript:hideCalendar();"><img name="calbtn2" src="../javascript/spiffycal/images/btn_close_small.gif" border="0" width="12" height="10"></a><\/td><\/tr><tr><td width="100%" align="center">';
