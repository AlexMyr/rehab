...
function secure_domain($domain)
{
	return ereg("^([-_a-z0-9A-Z]+)((\.)([-a-zA-z0-9])+)+$",$domain); //"^([_a-z0-9A-Z-]+(\.)*)+((\.)+([_a-z0-9A-Z-])+)$"
}
...
{
	return ereg("^([-_a-z0-9A-Z]+)((\.)([-a-zA-z0-9])+)+(\.){0,1}$",$domain);//'^([_a-z0-9A-Z-]+)(\.)([_a-z0-9A-Z-]+)(\.)([_a-z0-9A-Z-]+)(\.){0,1}$'
}
